    ...
    static void febonacchi(int n) {
        ...
        while (n < 7) {
            if (n == 0) {
                ...
                ++n; // humne pehle n==0 ko badha diya hai turant hi to jvm ki vjh se iteration
                     // khatam ho jayengi or next par jayengi bhi nahi
                continue;// agr humne continue ka use kiya hai to hum is vali iteration se jump kar rhe
                         // hai so it is a better way
            } else if (n == 1) {
